...
speedRange.addEventListener('input',()=>{speedBPM=Math.max(60,parseInt(speedRange.value,10));speedLabel.textContent=speedBPM;savePrefs();if(running&&!waitingForEval)startBeats();});
